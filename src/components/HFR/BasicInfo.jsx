                ...
                <div className="boxHprBody">
                    <div className="row">
                        <div className="col-xs-12 col-md-12">
                            <div className="feilds">
                                <div className="newRadioFeildsUI boxDetaRad">
                                    <label>
                                        <input type="radio" name="renewal" />
                                        <div className="detRad">
                                    ...
                                    <label>
                                        ...
                                        <div className="detRad">
                                            <h5>Facility
                                                Manager/Administrator</h5>
                                        </div>
                                    </label>
                                    <label>
                                        <input type="radio" name="renewal" />
                                        <div className="detRad">
                                            <h5>Healthcare Professional
                                                & Facility Manager</h5>
                                            <span>(Doctor/Nurses and facility manager)</span>
                                        </div>
                                    </label>
                                </div>
                            </div>
