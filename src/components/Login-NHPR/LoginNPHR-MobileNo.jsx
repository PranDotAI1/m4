        ...
        <>
            ...
            <div className="flow-feilds">
                ...
                <div className="gridFeilds">
                    <div className="feildsColum">
                        <div className="feilds">
                            ...
                            <input type="text" className="filds-form" placeholder="Enter OTP" maxLength="18"
                                autoComplete="off" />
                            <p className="donthaveRecivedOtp">Didn't receive the OTP? <span>Resend OTP in : 00:59 sec</span></p>
                        </div>
                    </div>
                </div>

                <div className="HP-idSection">
                    <label>
                        <div className="selectSection">
                            <input type="radio" name="hpLogin" />
                        </div>
                        <div className="SelectDetailsSec">
                            <h4>Rajeev Venkatramana Karemane</h4>
                            <div className="showHideView">
                                <span>71-*********-1233</span>
                                <span>9876543210@hpr.abdm</span>
                            </div>
                        </div>
                    </label>
                    <label>
                ...
                <div className="feilds feildsBtn mt-4">
                    ...
                    <button className={`custBtn ${formateAbha.length == 17 ? 'btnSuccess' : 'disabled'}`} disabled={formateAbha.length !== 17} onClick={!showOtpBox ? handleSendOtp : verifyOtp}> {!showOtpBox ? 'Continue' : 'Verify'} <i className="material-icons">arrow_right_alt</i></button>
                </div>
            </div>
        </>
    )
...
export default LoginNHPRMobileNumber
